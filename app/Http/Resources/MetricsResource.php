...
class MetricsResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'efficienza'=>(($this->risparmio_giornaliero_da_spreco+$this->risparmio_giornaliero_da_eccesso)/($this->$this->risparmio_giornaliero_da_spreco+$this->risparmio_giornaliero_da_eccesso+$this->spreco_giornaliero+$this->eccsso_giornaliero))*100,
            ...
            'inefficienza'=>100-((($this->risparmio_giornaliero_da_spreco+$this->risparmio_giornaliero_da_eccesso)/($this->$this->risparmio_giornaliero_da_spreco+$this->risparmio_giornaliero_da_eccesso+$this->spreco_giornaliero+$this->eccsso_giornaliero))*100),
